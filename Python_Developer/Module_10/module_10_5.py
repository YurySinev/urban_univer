...
#
# Подготовка:
# Скачайте архив с файлами https://drive.google.com/file/d/1YqBBelk2Pedfrg9GyXTGYvpa8Qb5CNd6/view?usp=sharing
# для считывания данных и распакуйте его в проект для дальнейшего использования.
#
# Выполнение:
...
#
# Этих операций достаточно, чтобы рассмотреть преимущество многопроцессорного выполнения программы над линейным.

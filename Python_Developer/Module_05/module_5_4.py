...
# second=25 и third=3.14 передаются (упаковываются) в **kwargs
# т.к. это именованные аргументы.
# Они будут находиться под ключами 'second' и 'third'
# со значением 25 и 3.14 соответственно в словаре.
#
# Передача данных из __new__ в __init__:
# После того как метод __new__ отработает до конца, произойдут
# следующие события с параметрами __init__:
...
# Для решения этой задачи будем пользоваться решением
# к предыдущей задаче "Перегрузка операторов".
#

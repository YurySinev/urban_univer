...
# Вызовите функцию single_root_words и выведите на экран(консоль) возвращённое ей значение.
#
